  ...
  return (
    <section className="flex flex-col gap-6">
      <header className="flex flex-col gap-3 text-center">
        <h1 className="text-3xl font-bold text-cyan-300 sm:text-4xl">PDF Beans</h1>
        <p className="text-base text-slate-300 sm:text-lg">
          Generate beautiful PDFs from archived versions of web pages. Choose a service, paste the
          URL, and we&apos;ll brew the PDF for you.
        </p>
      </header>
